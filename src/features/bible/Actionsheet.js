...
const ActionSheet = ({
  bookName, chapter, verseNum, verseEnd, isSaved, isEditingNote, noteText,
  onNoteChange, onClose, onCopy, onShare, onToggleSave, onHighlightColorSelect, onOpenNote, onSaveNote, onCancelNote,
  bottomOffset = 90,
}) => {
...
const styles = StyleSheet.create({
  actionSheetContainer: { position: 'absolute', left: 16, right: 16, backgroundColor: '#ffffff', borderRadius: 24, padding: 20, borderWidth: 1.5, borderColor: '#352a48', elevation: 20, shadowColor: '#000', shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.15, shadowRadius: 12, zIndex: 10 },
